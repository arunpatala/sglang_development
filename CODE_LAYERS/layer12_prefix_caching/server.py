"""
Layer 12 — Server: async FastAPI + asyncio.Future bridge to the Scheduler.
...
CLI args override individual fields:
    ...
    python server.py --chunked-prefill-size 512        # enable chunked prefill
...
def _parse_args() -> dict:
    p = argparse.ArgumentParser(description="Layer 12 inference server")
...
# ── App state ─────────────────────────────────────────────────────────────────
app       = FastAPI(title="Layer 12 — Prefix Caching")
