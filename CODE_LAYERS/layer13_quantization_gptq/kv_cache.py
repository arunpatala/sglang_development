"""
Layer 11 — KV Cache: ExtendKVCtx + prefix-caching awareness.

━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
What changes from Layer 10
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━

  Layer 10 (ExtendKVCtx):             Layer 11 (ExtendKVCtx + RadixCache):
  ─────────────────────────────────   ─────────────────────────────────────
  All prompt tokens go through model  Cached-prefix tokens skipped entirely
  kv_committed_len starts at 0        kv_committed_len starts at prefix_len
  slot_indices starts empty           slot_indices pre-populated w/ prefix pages
  Allocates pages for all tokens      Only allocates pages for new (non-cached) tokens

  The KV cache objects (ExtendKVCtx, DecodeKVCtx, compute_write_info) are
  unchanged — prefix awareness is handled entirely by model_runner.py and
  the new radix_cache.py.  compute_write_info correctly handles a non-zero
  kv_committed_len with n_leftover=0 (because prefix_len is always page-aligned).
