"""
CODE_LAYERS / Layer 2 — Benchmark
===================================
Same dataset, same seed, same N as Layers 0 and 1 — results are directly comparable.

The only differences from layer1/benchmark.py:
  - Default port: 8102
  - Default layer label: 2
  - benchmark.md analysis text updated to reflect KV cache expectations
...
parser = argparse.ArgumentParser(description="Layer 2 benchmark — throughput measurement")
parser.add_argument("--host", default="localhost")
parser.add_argument("--port", type=int, default=8102, help="Layer server port")
parser.add_argument("--layer", type=int, default=2, help="Layer number (label only)")
