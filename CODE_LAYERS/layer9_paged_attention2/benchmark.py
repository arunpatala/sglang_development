"""
Layer 8 — Benchmark: constant-concurrency sliding window.
...
def report(results: list[dict], total_s: float, n: int) -> None:
    ...
    print()
    print("=" * 60)
    print(f" Layer 8 — Paged KV Cache + Triton kv_indices Benchmark")
    ...
    md = Path(args.output)
    section = f"""
## Layer 8 — Paged KV Cache + Triton kv_indices
